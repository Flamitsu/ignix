# Ignix warning
This project is not abandoned. Has been put on hold / slow down a lot. My studies force me to do an application project and I need to switch focus. If you can't find my application project its because it needs to be private until June / July (presentation day).
